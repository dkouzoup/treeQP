...
void stage_qp_qpoases_set_CmPnCmT(tree_qp_in *qp_in, int idx, int idxdad, int offset, void *work_);

void stage_qp_qpoases_add_EPmE(tree_qp_in *qp_in, int idx, int idxdad, int offset, void *work_);

void stage_qp_qpoases_add_CmPnCkT(tree_qp_in *qp_in, int idx, int idxsib, int idxdad, int row_offset, int col_offset, void *work_);

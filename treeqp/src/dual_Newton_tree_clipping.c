...
void stage_qp_clipping_set_CmPnCmT(const tree_qp_in *qp_in, int idx, int idxdad, int offset,
    void *work_)
{
    treeqp_tdunes_workspace *work = (treeqp_tdunes_workspace *) work_;
...
void stage_qp_clipping_add_CmPnCkT(const tree_qp_in *qp_in, int idx, int idxsib, int idxdad,
